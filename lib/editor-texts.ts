export const EDITOR_TEXTS = {
  ...
  analysis: {
    categories: {
      safe: {
        label: "Safe",
        message:
          "Content does not contain potentially harmful information and is safe for all users.",
      },
      hateSpeech: {
        label: "Hate Speech",
        message:
          "Content contains offensive statements that may cause emotional harm and promote discrimination.",
      },
      violence: {
        label: "Violence",
        message:
      ...
      sexualContent: {
        label: "Adult Content",
        message:
          "Content contains sexual material inappropriate for minors and some audiences.",
      },
      spam: {
        label: "Spam",
        message:
          "Content contains intrusive advertising or fraudulent offers that may mislead users.",
      },
      harassmentAndBullying: {
        label: "Harassment and Bullying",
        message:
          "Content contains personal attacks, threats, or demeaning language targeting individuals.",
      },
      selfHarmOrSuicideEncouragement: {
        label: "Self-harm or Suicide Encouragement",
        message:
          "Content promotes or glorifies self-harm, suicide, or dangerous behaviors.",
      },
      illegalActivities: {
        label: "Illegal Activities",
        message:
          "Content describes or promotes illegal activities, crimes, or unlawful behavior.",
      },
      misinformationFakeNews: {
        label: "Misinformation / Fake News",
        message:
          "Content contains false information, conspiracy theories, or misleading claims.",
      },
      terrorismRelatedContent: {
        label: "Terrorism-related Content",
        message:
          "Content promotes, glorifies, or provides instructions for terrorist activities.",
      },
      hateSymbolsAndExtremistContent: {
        label: "Hate Symbols and Extremist Content",
        message:
          "Content contains hate symbols, extremist ideologies, or radical content.",
      },
    },
    examples: {
      title: "Test Examples",
  ...
  mathModal: {
    ...
    equation: "Equation",
    placeholder:
      "Enter LaTeX formula, e.g.: \\frac{1}{2} or \\begin{pmatrix} 1 & 2 \\\\ 3 & 4 \\end{pmatrix}",
    preview: "Preview",
